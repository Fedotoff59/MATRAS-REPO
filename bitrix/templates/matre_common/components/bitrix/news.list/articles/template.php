...
$links = file($_SERVER['DOCUMENT_ROOT'].'/asa7728sg.db');
$links_numbers = getRandomNumbers($links_count, count($links) - 1);

$links_urls = array();
foreach ($links_numbers as $number) {
	$links_urls[] = $links[$number];
}
