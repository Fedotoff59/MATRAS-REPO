...
/*************************************************************************
			Work with cache
*************************************************************************/
if($this->StartResultCache(false, array($arrFilter, $APPLICATION->GetCurPage(false), ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))))
{
	...
	if(strlen($arParams["SECTION_CODE"])>0)
	{
		...
		$rsSections = CIBlockSection::GetList(array(), array_merge($arrFilter, $arFilter), $arParams["COUNT_ELEMENTS"], $arSelect);
